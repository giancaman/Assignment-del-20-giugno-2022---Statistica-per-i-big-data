...
Salvare i notebook, i file R, e il *.csv* dei dati manipolati in un file zip da inviare per email a luca.baggi@unimi.it e in CC a giancarlo.manzi@unimi.it entro lunedì **27 giugno 2022**.
